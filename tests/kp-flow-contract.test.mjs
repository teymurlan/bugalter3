...
const publicOrderWorker = readFileSync('src/production-public-order.js', 'utf8');
...
assert.ok(wrangler.includes('src/production-public-order.js'), 'wrangler must point to the public order production wrapper');
assert.ok(publicOrderWorker.includes("./demo-worker-v53-client-experience.js"), 'public order wrapper must preserve release 53 as its base');
