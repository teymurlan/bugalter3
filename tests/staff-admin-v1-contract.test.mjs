...
test('client booking remains on the proven v2 path with release 44 hardening layered above it', () => {
  assert.match(index, /app-release-v3\.js\?v=44/);
  assert.match(entry, /else\s*\{\s*import\('\.\/app-release-v2\.js\?v=44'\)/s);
