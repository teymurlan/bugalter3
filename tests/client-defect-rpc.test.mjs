...
const publicOrderWorker=fs.readFileSync('src/production-public-order.js','utf8');
...
test('active worker keeps full production chain through public numbering, release 53, shared booking and defect wrapper',()=>{
  ...
  assert.ok(publicOrderWorker.includes("from './demo-worker-v53-client-experience.js'"));
