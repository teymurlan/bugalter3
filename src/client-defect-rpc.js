...
export class AppStore extends BaseAppStore {
  ...
  /**
   * Private Durable Object RPC used only by HOUSE CLEANING STAFF.
   * The browser cannot call this method. The worker-to-worker DO binding can.
   * Each defect id is idempotent, so retries do not send duplicate photos.
   */
